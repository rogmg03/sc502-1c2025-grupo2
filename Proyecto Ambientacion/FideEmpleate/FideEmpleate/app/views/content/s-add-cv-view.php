        ...
        <div class="card-body">
          <form>
            ...
            <div id="informacionPersonal" class="form-section active">
              ...
              <textarea class="form-control" id="direccionEstudiante" rows="4" placeholder="Provincia, Cantón, Distrito..." required></textarea>

              <label for="descripcionSobreMi" class="form-label mt-2">Sobre mí</label>
              <textarea class="form-control" id="descripcionSobreMi" rows="4" placeholder="Describe como eres..."></textarea>
            ...
            <div id="experienciaLaboral" class="form-section">
              ...
              <textarea class="form-control" id="descripciondelempleo" rows="4" placeholder="Describe la empresa..."></textarea>
            </div>
            ...
            <div>
              <button style="font-weight: bolder; border-radius: 100%; color:white; margin-left: 46%;" class="btn-info btn btn-center">+</button>
            </div>
