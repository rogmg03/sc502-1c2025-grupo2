...
<body>
    ...
    <div class="vertical-nav">
        ...
        <a href="<?php echo APP_URL; ?>a-chat/" class="link-activo">Chat Alumnos</a>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center">
            <h2>Chat Alumnos</h2>
            <button class="btn btn-dark btn-sm" data-bs-toggle="modal" data-bs-target="#modalAgregarConversacion">
    ...
    <div class="modal fade" id="modalAgregarConversacion" tabindex="-1" aria-hidden="true">
    ...
    <script>
        ...
        document.getElementById('btnConfirmarChat').addEventListener('click', function () {
            if (estudianteSeleccionado) {
                window.location.href = "<?= APP_URL ?>a-chat/?id=" + estudianteSeleccionado;
            }
        });
    </script>
