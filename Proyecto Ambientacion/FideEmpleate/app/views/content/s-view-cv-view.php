...
<div class="main-content">
    ...
    <a href="<?php echo APP_URL; ?>s-add-cv/" class="btn btn-dark btn-sm py-1" id="agregarCurriculum">Agregar Curriculum</a>
                    ...
                    <?php if (!empty($curriculums)): ?>
                        <?php foreach ($curriculums as $cv): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= APP_URL ?>s-view-my-cv/<?= $cv['id_cv'] ?>" class="btn btn-primary btn-sm">Ver</a>
                                    <a href="<?= APP_URL ?>s-edit-cv/<?= $cv['id_cv'] ?>" class="btn btn-secondary btn-sm">Editar</a>
