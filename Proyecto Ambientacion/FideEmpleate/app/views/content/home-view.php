...
<a href="<?php echo APP_URL; ?>login/" class="btn btn-outline-primary btn-sm">Iniciar Sesión</a>
</div>

<!-- Sección principal -->
<div class="hero">
    <h1>Bienvenido a FideEmpleate!!</h1>
    <p>
    ...
    <a href="<?php echo APP_URL; ?>register/" class="btn btn-primary">Registrarse Ahora</a>
</div>
